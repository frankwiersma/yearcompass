...
export function Sidebar({
  ...
  return (
    <aside className="w-80 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm h-screen
      ...
      <div className="md:hidden sticky bottom-0 p-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-t border-gray-200 dark:border-gray-700">
